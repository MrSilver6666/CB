...
unsigned int nTargetSpacing = 2 * 60; // 2 minutes / 120 seconds
...
const string strMessageMagic = "CryptoBancor Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if (pindexBest->nHeight+1 == 3)
    {
      nSubsidy = 463993 * COIN;
      return nSubsidy + nFees;
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CryptoBancor", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Sat, 18 Oct 2014 16:31:31 GMT";
        CTransaction txNew;
        txNew.nTime = 1413649891;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1413649891;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2038111;
		if(fTestNet)
        {
            block.nNonce   = 2038111;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x78269e2294aafe4af06d8b342433b0a011c1c46f0d208d38342905d6e6cdd549"));
        block.print();
