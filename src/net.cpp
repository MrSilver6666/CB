...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("CryptoBancor-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("CryptoBancor-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "CryptoBancor " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("CryptoBancor-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("CryptoBancor-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("CryptoBancor-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("CryptoBancor-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. CryptoBancor is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("CryptoBancor-start");
